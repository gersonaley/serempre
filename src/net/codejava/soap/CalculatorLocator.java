...
public class CalculatorLocator extends org.apache.axis.client.Service implements net.codejava.soap.Calculator {
    ...
    public net.codejava.soap.CalculatorSoap getCalculatorSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            net.codejava.soap.CalculatorSoapStub _stub = new net.codejava.soap.CalculatorSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (net.codejava.soap.CalculatorSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                net.codejava.soap.CalculatorSoapStub _stub = new net.codejava.soap.CalculatorSoapStub(new java.net.URL(CalculatorSoap_address), this);
                _stub.setPortName(getCalculatorSoapWSDDServiceName());
                return _stub;
            }
        }
